...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "https://github.do/https://github.com/cheneysong/qinglong.git" ${current_branch}
    ...
    local url="https://github.do/https://github.com/whyour/qinglong-static.git"
